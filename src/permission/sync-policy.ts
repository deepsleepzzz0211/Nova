...
/**
 * Synchronous permission policy that maintains backward compatibility.
 * This version keeps the original synchronous behavior while implementing the PermissionChecker interface.
 */
export class SyncPermissionPolicy {
